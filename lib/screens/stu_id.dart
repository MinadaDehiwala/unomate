...
class StudentIDPhotoScreen extends StatefulWidget {
  const StudentIDPhotoScreen({super.key});

  @override
  _StudentIDPhotoScreenState createState() => _StudentIDPhotoScreenState();
}

class _StudentIDPhotoScreenState extends State<StudentIDPhotoScreen> {
  File? _image;
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Upload a photo of your University ID\nYour data is secured',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 24,
